...
outflow (e.g., SiO and H$_2$O) lines.  Only two to three emission lines are now
unidentified in the B6 and B7 spectra, though there are over a dozen in B3 that
we have not identified. 

We also tentatively identify broad lines at 229.7 and 344.4 GHz as AlO.  If
...
catalogs available in any of the standard online databases \citep[i.e., CDMS,
SLAIM, JPL;][]{Muller2005b,Lovas2005b,Pickett1998a}.  We obtained the KCl
frequencies for these lines from the catalogs of \citet{Barton2014a}, which were
designed primarily for use in exoplanet atmospheres and include over 10$^5$
...
fitted models to the higher-$v$ states tabulated by Barton to obtain corrected
...
% JPL, and SLAIM.  The latter three, cataloged in Splatalogue, agree, and they
...
A few of the integrated intensities (e.g., for the KCl $v=5$ $J=45-44$ line) are discrepantly
...
source has a luminosity $L=10^4 \lsun = 4 \pi r^2 \sigma_{SB} T^4$ \referee{($T_*=4000$ K, $R_*=210$ \rsun)}, where we
...
\includegraphics[scale=1,width=2.25in]{figures/OrionSourceI_NaClv=2_26-25_robust0.5.maskedclarkclean10000_medsub_K_peak_offset_B6cont_contours.pdf}
...
White contours are shown at \referee{50 and 100 K (left), 50, 100,  150, and 200 K (center),
...
\citep{Barton2014a,Cabezas2016a}.  The collision rates into the $v=0$ states are
...
$T=100$ K \citep{Quintana-Lacaci2016a}.  Thus, extremely high gas temperatures
...
could also be important.  Using the approximations from \citet{Dickinson1975b},
...
$10^5$ times more efficient at exciting these molecules than \hh. In typical
...
molecules \citep{Zeiri1983, Silver1986a}, which
...
the $J=45-44$ transition would be nine times as bright as the $J=13-12$ transition.
% $T_{B}(\textrm{KCl
...
eV, respectively.  These atoms would be nearly fully ionized between 1500 and 2000
...
Given the rarity of these molecules, if they can be detected elsewhere, they
will serve as a powerful and unique probe of local conditions.  They may be the
best available molecular tool for finding disks around high-mass protostars and
measuring their kinematics.  
...
\texttt{astroquery}
\citep[][and~\url{astroquery.readthedocs.io}]{Ginsburg2019a}
