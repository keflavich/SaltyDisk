...
we found a systematic discrepancy %in 
...
to be systematically offset by $\sim$15-20 \kms \rlp{in the Barton paper?}. The offset is a function of
the vibrational
...
in both catalogs
the resulting offsets \rlp{frequency differences?} are generally $<0.1$ \kms, which is more than 
sufficient for a reliable match to our observational spectra.  We then applied
these fitted models to the higher-$v$ states \rlp{tabulated by Barton?} to get corrected rest frequencies.
