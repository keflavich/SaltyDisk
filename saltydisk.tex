...
across the \sourcei disk.  We then shift the spectrum associated with
this pixel to 0 \kms.  We then average the spectra over the region with
significant emission oin the NaCl line.  
create a velocity centroid map across the \sourcei disk.
We shift the spectrum associated with each spatial pixel 
For each spectrum in the
line data cube with
