...
masers in an outflow \citep{Goddi2009a,Matthews2010a,Goddi2010a,Goddi2013a,Greenhill2013a}.
...
detected in space \citep{McGuire2018c}.
...
carbon star IRC +10216 \citep{Cernicharo1987a}, oxygen-rich evolved stars IK
Tauri and VY Canis
...
range of radii from the central star as they are blown away
...
are detected.  
% since excitation requires only 5 eV, not 13.6 eV, lack of e-p free-free emission 
% really isn't significant; in fact, 5000 K photosphere seen in reflection nebulosity 
% could explain these photons?
%\sourcei has no electron-proton free-free emission
%\citep{Plambeck2013a}, so a strong $\lambda<912$ \AA\ UV field is ruled out. 
While UV
...
% However, the \citet{Decin1986a} model assumes that NaCl exists entirely
...
protostars \citep[e.g.  HH80/81;][]{Girart2017a}.
