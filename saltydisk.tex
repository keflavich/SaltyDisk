...
by][]{XXX} \bam{This reference should be `McGuire 2018 ApJs in press' for now.}.   Because of their rarity, their use as a diagnostic
...
$n\gtrsim10^{18}$ \percc are requried to collisionally excite the v=6 lines.
...
\bam{At least in laboratory plasmas, the vibrational temperature of many molecules is directly coupled to the electron temperature.  Different density environments, though...}
