...
obscuration can occur on sub-beam scales.  However, the morphology of the salt
lines does not change with frequency.  Figure \ref{fig:resolutioncomparison}
shows a selected salt line from each of the observed frequency windows, as in
Figure \ref{fig:spatial}, convolved to a common resolution.  If selective
obscuration was a significant effect, we would expect to see progressively less
...
0.87 mm, and the southeast end of the disk is brighter at 1.4 mm than at either
3 mm or 0.87 mm, but overall the morphology is similar in all wavebands when
viewed at the same resolution.  We attribute the remaining residuals to the
