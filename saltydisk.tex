...
Since the highest clearly detected energy state detected has $E_U\sim2500$ K
(see Table \ref{tab:all_detections_B3}) {\color{red} there are plots with EU=3500K,
what gives?}, the radiation field likely turns over at around this temperature,
implying the presence of a cooler radiation field than implied in \citet{Testi2010a}.
The lower temperatures could either be because the central source is intrinsically
cooler or could be produced by extinction between the source and the disk.
